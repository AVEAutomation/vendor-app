/**
 * @ngdoc controller
 * @name vendorAppApp.admin.user.list.edit.controller:UserEditController
 * @description
...
(function () {
  ...
  /**
   * @ngdoc function
   * @name vendorAppApp.admin.user.list.edit.provider:UserEditController
   * @description
   * Provider of the {@link vendorAppApp.admin.user.list.edit.controller:UserEditController UserEditController}
