/**
 * @ngdoc overview
 * @name vendorAppApp.admin.user.list.detail
 * @description
 * The `vendorAppApp.admin.user.list.detail` module which provides:
 *
 * - {@link vendorAppApp.admin.user.list.detail.controller:UserDetailController UserDetailController}
 *
 * @requires ui.router
 * @requires angularMoment
 * @requires vendorAppApp.auth.user
 */
(function () {
  'use strict';
