(function () {
  ...
  /**
   * Introduce the vendorAppApp.user module
   * and configure it.
   *
   * @requires ngResource
   * @requires ui.router
   * @requires {vendorAppApp.admin.user.list}
   * @requires {vendorAppApp.admin.user.create}
   */
  angular
    .module('vendorAppApp.admin.user', [
      'ngResource',
      'ui.router',
      'vendorAppApp.admin.user.list',
      'vendorAppApp.admin.user.create'
    ])
