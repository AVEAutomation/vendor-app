/**
 * @ngdoc overview
 * @name vendorAppApp.admin.user.create
 * @description
 * The `vendorAppApp.admin.user.create` module which provides
 *
 * - {@link vendorAppApp.admin.user.create.controller:UserCreateController UserCreateController}
 *
 * @requires ui.router
 * @requires ngMaterial
 * @requires ngMessages
